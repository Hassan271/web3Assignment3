...
var reaminigDays:number=Days%7
...
var productPrice:number= 122 ;                            // price in Dollar  , And it will not work on -ve price .
var discount:number= productPrice * (10 / 100);           //10% of discount 
var discountedPrice10per = "if prince is above 100$ Discounted price is = "+ (productPrice - discount);

var discount5per :number= productPrice * (5 / 100);      //5% of discount 
